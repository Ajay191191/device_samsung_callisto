...
## Ramdisk
PRODUCT_COPY_FILES += \
    device/samsung/callisto/ramdisk/lib/modules/fsr.ko:root/lib/modules/fsr.ko \
    device/samsung/callisto/ramdisk/lib/modules/fsr_stl.ko:root/lib/modules/fsr_stl.ko \
    device/samsung/callisto/ramdisk/lib/modules/sec_param.ko:root/lib/modules/sec_param.ko

## Prebuilt init.d scripts
PRODUCT_COPY_FILES += \
    device/samsung/callisto/prebuilt/etc/init.d/01bt:system/etc/init.d/01bt 
...
PRODUCT_COPY_FILES += \
    ...
    device/samsung/callisto/prebuilt/etc/audio_effects.conf:system/etc/audio_effects.conf \
    device/samsung/callisto/prebuilt/etc/sysctl.conf:system/etc/sysctl.conf \
...
## ICS GPS blob
PRODUCT_COPY_FILES += \
    device/samsung/callisto/prebuilt/lib/hw/gps.callisto.so:system/lib/hw/gps.callisto.so
